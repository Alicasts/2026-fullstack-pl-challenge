...
| RQF-USER-003 | Administradores podem editar dados de qualquer usuário. Atendentes podem editar apenas os dados do próprio usuário. Os campos editáveis são os mesmos do cadastro, exceto e-mail e senha. As mesmas validações de cadastro devem ser aplicadas na edição. Ao salvar, o sistema deve validar e persistir as alterações. | — | — | ⏳ |
